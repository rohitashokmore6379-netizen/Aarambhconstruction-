...
import { FileText, Printer, Download, Building2, TrendingUp, Wallet, ArrowUpRight, ArrowDownRight } from 'lucide-react';
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-2 border-b border-slate-800 no-print">
        <div>
          <h1 className="text-2xl font-black text-white tracking-tight flex items-center gap-2">
            Executive Financial Audit Statements
          </h1>
          <p className="text-xs text-slate-400 mt-1">
            Consolidated project margins, client receivables, and verified ledger balance sheets.
          </p>
        </div>

        <button
          onClick={handlePrint}
          className="px-4 py-2 bg-amber-500 hover:bg-amber-400 text-slate-950 font-bold rounded-xl text-xs flex items-center gap-1.5 shadow-md shadow-amber-500/10 transition-all self-start sm:self-auto"
        >
